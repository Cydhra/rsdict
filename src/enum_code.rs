...
unsafe fn rank_with_popcount(code: u64, class: u8, pos: u64) -> u64 { rank_impl(code, class, pos) }
...
mod tests {
    ...
    #[quickcheck]
    fn qc_enum_code(value: u64) -> bool { check_value(value) }

    #[quickcheck]
    fn qc_enum_code_hashed(value: u64) -> bool { check_value(hash_u64(value)) }
...
pub const ENUM_CODE_LENGTH: &[u8; 65] = &[
    0, 6, 11, 16, 20, 23, 27, 30, 33, 35, 38, 40, 42, 44, 46, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64,
    64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 46, 44, 42, 40, 38,
    35, 33, 30, 27, 23, 20, 16, 11, 6, 0,
];
